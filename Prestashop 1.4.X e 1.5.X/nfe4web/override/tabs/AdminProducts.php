...
* 
* Adaptado por PrestaBR <http://prestabr.com.br> - Nfe4Web
*/
...
class AdminProducts extends AdminTab
{
	...
	function displayFormInformations($obj, $currency)
	{
		...
		echo '		</td>
					...
					<!-- NFe4Web -->
					<tr>
						<td class="col-left">'.$this->l('NCM Code:').'</td>
						<td style="padding-bottom:5px;">
							<input size="55" maxlength="12" type="text" name="ncm" value="'.htmlentities($this->getFieldValue($obj, 'ncm'), ENT_COMPAT, 'UTF-8').'" style="width: 130px; margin-right: 5px;" /> <span class="small">'.$this->l('8 or 2 digits(type)').'</span>
						</td>
					</tr>

					<tr>
						<td class="col-left">'.$this->l('Tax Substitution:').'</td>
						<td style="padding-bottom:5px;">
							<input style="float:left;" type="radio" name="subst" id="subst_on" value="1" '.($this->getFieldValue($obj, 'subst') ? 'checked="checked" ' : '').'/>
							<label for="subst_on" class="t"><img src="../img/admin/enabled.gif" alt="'.$this->l('Yes').'" title="'.$this->l('Yes').'" style="float:left; padding:0px 5px 0px 5px;" />'.$this->l('Yes').'</label>
							<br class="clear" />
							<input style="float:left;" type="radio" name="subst" id="subst_off" value="0" '.(!$this->getFieldValue($obj, 'subst') ? 'checked="checked" ' : '').'/>
							<label for="subst_off" class="t"><img src="../img/admin/disabled.gif" alt="'.$this->l('No').'" title="'.$this->l('No').'" style="float:left; padding:0px 5px 0px 5px" />'.$this->l('No').'</label>
						</td>
					</tr>
					<!-- NFe4Web -->
