...
<div id="step1">
	...
	{* global information *}
        ...
        <!-- NFe4Web -->
        <tr>
            <td class="col-left"><label>{l s='NCM Code:'}</label></td>
            <td style="padding-bottom:5px;">
                <input size="55" type="text" name="ncm" value="{$product->ncm}" maxlength="8" style="width: 130px; margin-right: 5px;" /> <span class="small">{l s='8 or 2 digits(type)'}</span>
            </td>
        </tr>

        <tr>
            <td class="col-left"><label>{l s='Tax Substitution:'}</label></td>
            <td style="padding-bottom:5px;">
                <input style="float:left;" type="radio" name="subst" id="subst_on" value="1" {if ($product->subst) eq '1'} checked="checked"{/if}/>
                <label for="subst_on" class="t"><img src="../img/admin/enabled.gif" alt="{l s='Yes'}" title="{l s='Yes'}" style="float:left; padding:0px 5px 0px 5px;" />{l s='Yes'}</label>
                <br class="clear" />
                <input style="float:left;" type="radio" name="subst" id="subst_off" value="0" {if $product->subst eq '0'} checked="checked"{/if}/>
                <label for="subst_off" class="t"><img src="../img/admin/disabled.gif" alt="{l s='No'}" title="{l s='No'}" style="float:left; padding:0px 5px 0px 5px" />{l s='No'}</label>
            </td>
        </tr>
        <!-- NFe4Web -->
