	...
	function displayFormInformations($obj, $currency)
	{
		...
		echo '		</td>
					...
					<tr>
						...
						<td style="padding-bottom:5px;">
							<input size="55" maxlength="8" type="text" name="ncm" value="'.htmlentities($this->getFieldValue($obj, 'ncm'), ENT_COMPAT, 'UTF-8').'" style="width: 130px; margin-right: 5px;" /> <span class="small">'.$this->l('8 or 2 digits(type)').'</span>
						</td>
					</tr>
